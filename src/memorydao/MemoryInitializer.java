...
public class MemoryInitializer implements LoaderDAO {
	...
	public void loadUsers() {
		...
		UserMemoryDAO.users.add(new User(1, "Nikos", "Papastamatakis", new Email("nikos.papastamatakis@gmail.com"), new Password("vaggelis"), 20, new CreditCard(420420421, "pireos"), true));
		UserMemoryDAO.users.add(new User(2, "Athanasia", "denThimame", new Email("athanasia@gmail.com"), new Password("lala"), 22, new CreditCard(426520421, "pireos"), true));
